...
public final class ConfigReader
{
     ...
     * @param resolve true if a parsed address should be checked to be resolved.
     ...
     */
    public static List<InetSocketAddress> read(String path, boolean ignoreErrors, boolean resolve)
    {
        ...
        try (
            ...
            while ((line = buf.readLine()) != null)
            {
                try
                {
                    InetSocketAddress a = TokenParser.parseAsAddress(line, resolve);
